            ...
            <div className="absolute inset-0 z-20 pointer-events-none p-6 sm:p-10 flex flex-col justify-between">
                ...
                <div className="flex justify-between items-end">
                    ...
                    <div className="flex gap-2 pointer-events-auto">
                        <a href="https://www.linkedin.com/company/global-web-production/" className="w-10 h-10 bg-black/30 backdrop-blur-md border border-white/10 flex items-center justify-center rounded text-white/50 hover:text-white hover:border-[#57C2FF] hover:bg-[#57C2FF]/20 transition-all">
