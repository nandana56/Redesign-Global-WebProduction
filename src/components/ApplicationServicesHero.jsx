...
const text = "Future-Ready Applications, Built to Scale";
const textVariants = {
    hidden: { opacity: 0 },
    visible: {
        opacity: 1,
    ...
    return (
        <section className="relative w-full h-[600px] flex overflow-hidden font-poppins selection:bg-blue-500/30 bg-neutral-950">
            ...
            <div className="w-full md:w-1/2 h-full flex flex-col justify-center px-8 md:px-12 lg:px-20 z-10">
                ...
                >
                    ...
                    <motion.p 
                        ...
                        className="text-sm sm:text-lg font-semibold text-blue-100/70"
                    >
                        Elevate your digital products with robust Quality Engineering & Assurance solutions.
                    </motion.p>
            ...
            <div className="hidden md:block w-1/2 h-full relative bg-neutral-900">
                ...
                <img 
                    src="/Assets/application support services Banner.webp" 
            ...
            <div className="md:hidden absolute inset-0 z-0 bg-neutral-900">
                <img 
                    src="/Assets/application support services Banner.webp" 
                    alt="Application Services Background" 
                    className="w-full h-full object-cover"
                />
...
export default ApplicationServicesHero;
