...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-r from-[#061539] via-[#062157] to-[#062862] text-white border-t border-white/10 pt-20 pb-10 font-poppins">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10 mb-16">
                    {/* Column 1: Company */}
                    <div className="lg:col-span-1">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-[#52b8f4] mb-6">Company</h4>
                        <ul className="space-y-4 text-sm">
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/">Home</Link></li>
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/about" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/about">About</Link></li>
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/contact" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/contact">Contact us</Link></li>
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/enterprise" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/enterprise">Enterprise Solutions</Link></li>
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/smb-solutions" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/smb-solutions">Small to Medium Business</Link></li>
                            <li className={`hover:text-[#52b8f4] cursor-pointer transition-colors ${location.pathname === "/careers" ? "text-[#52b8f4]" : "text-white"}`}><Link to="/careers">Careers</Link></li>
                        </ul>
                    </div>

                    {/* Column 2: Services Part 1 */}
                    <div className="lg:col-span-1">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-[#52b8f4] mb-6">Services</h4>
                        <ul className="space-y-4 text-sm">
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Application Support Services</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Enterprise Platform Services</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">CRM Implementation</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Software Product Development</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Quality Engineering & Assurance</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Engineering Research & Development</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Technology Consulting</li>
                        </ul>
                    </div>

                    {/* Column 3: Services Part 2 */}
                    <div className="lg:col-span-1">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-transparent mb-6">.</h4>
                        <ul className="space-y-4 text-sm text-white">
                            <li className="hover:text-[#52b8f4] cursor-pointer">Business Process Services</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Data & AI</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Agentic AI Solutions</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Intelligent Business Automations</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">GWP Insights</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Experimentation & Optimization</li>
                        </ul>
                    </div>

                    {/* Column 4: Services Part 3 */}
                    <div className="lg:col-span-1">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-transparent mb-6">.</h4>
                        <ul className="space-y-4 text-sm text-white">
                            <li className="hover:text-[#52b8f4] cursor-pointer">Digital Strategy</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Sustainability & Resilience</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Experience Studio</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Content Services</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Branding</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Games Production & Development</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer">Accessibility</li>
                        </ul>
                    </div>

                    {/* Column 5: Partners */}
                    <div className="lg:col-span-1">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-[#52b8f4] mb-6">Partners</h4>
                        <ul className="space-y-4 text-sm">
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Artech</li>
                            <li className="hover:text-[#52b8f4] cursor-pointer transition-colors text-white">Ladder7</li>
                        </ul>
                    </div>

                    {/* Column 6: Logo and Socials */}
                    <div className="lg:col-span-1 space-y-8 flex flex-col items-start lg:items-end text-left lg:text-right">
                        <div className="flex items-center justify-center lg:justify-end">
                            <div className="relative w-[136px] h-[128px] transform scale-[0.8] origin-right lg:translate-x-6">
                                {/* Logo SVG */}
                                <svg
                        ...
                        <div className="flex gap-4">
                            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-[#52b8f4] hover:text-white transition-all cursor-pointer border border-white/10">
                ...
                <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex flex-wrap gap-6 text-xs font-medium">
                        <span className="hover:text-[#52b8f4] cursor-pointer text-gray-400 transition-colors">PRIVACY POLICY</span>
                        <span className="hover:text-[#52b8f4] cursor-pointer text-gray-400 transition-colors">COOKIE POLICY</span>
                        <span className="hover:text-[#52b8f4] cursor-pointer text-gray-400 transition-colors">TERMS OF USE</span>
                        <span className="hover:text-[#52b8f4] cursor-pointer text-gray-400 transition-colors">SITEMAP</span>
                    </div>
                    <p className="text-xs text-gray-400 font-medium tracking-widest">© {new Date().getFullYear()} GLOBAL WEB PRODUCTION</p>
                </div>
            </div>
        </footer>
    );
